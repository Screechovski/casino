...
export const usersBets = {
  ...
  getters: {
    ...
    getAll: (state) => state,
    getGrayBetsSum: (state) => state.gray.reduce((prev, cur) => prev + cur.bet, 0),
    getOrangeBetsSum: (state) => state.orange.reduce((prev, cur) => prev + cur.bet, 0),
    getRedBetsSum: (state) => state.red.reduce((prev, cur) => prev + cur.bet, 0),
    getGreenBetsSum: (state) => state.green.reduce((prev, cur) => prev + cur.bet, 0)
  },
  mutations: {
